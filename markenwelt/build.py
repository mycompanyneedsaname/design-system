...
<style>
  ...
  *{{box-sizing:border-box}}
  ...
  .pers-ph{{aspect-ratio:4/5;background:var(--sand);border-radius:12px;position:relative;display:grid;place-items:center}}
  .pers-ph .ini{{font:500 34px/1 var(--mono);color:{PETROL};opacity:.35}}
  .pers-ph .ph-note{{position:absolute;left:10px;bottom:8px;font-family:var(--hand);font-weight:700;font-size:15px;color:{PETROL};transform:rotate(-4deg)}}
  ...
  <div class="wrap wp-grid">
    ...
    <svg class="wp-art" viewBox="0 0 600 320" role="img" aria-label="Eine Kurve mit markiertem Wendepunkt. Davor: Energiekostensteigerung, CO₂-Ausstoß, Rohstoff-Knappheit. Danach: sinkende Betriebskosten, Flexibilität, Resilienz. Am Wendepunkt: hier.">
      ...
      <g class="wp-note" font-family="Kalam, cursive" font-weight="700" font-size="24" fill="{PETROL}">
        <text x="24" y="44">Energiekostensteigerung,</text>
...
<section class="light" id="team">
  <div class="wrap">
    ...
    <div class="team">
      <article class="pers">
        <div class="pers-ph" aria-hidden="true"><span class="ini">MS</span><span class="ph-note">Foto folgt</span></div>
        <div>
          <span class="pers-role">Ressourceneffizienz</span>
          <h3>Michael Schenk</h3>
          <p>Micha war in rund 150 Betrieben. In den meisten hat er in der ersten Stunde die ersten Maßnahmen gefunden. Er übersetzt Technik und Wirtschaftlichkeit in Sätze, die man im Betrieb weitererzählt.</p>
          <p class="pers-q">„Der Blick von außen wirkt.“</p>
        </div>
      </article>
      <article class="pers">
        <div class="pers-ph" aria-hidden="true"><span class="ini">TW</span><span class="ph-note">Foto folgt</span></div>
        <div>
