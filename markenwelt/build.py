...
<header class="dark">
  <div class="wrap">
    ...
    <div class="hero grid2">
      <div>
        <h1><span class="pre">Unser Versprechen:</span>Der Modulare Effizienz-Baukasten.<span class="l2">Weniger Verbrauch, mehr Spielraum.</span></h1>
      </div>
...
<section class="sand wp-band" aria-label="Der Wendepunkt">
  <div class="wrap wp-grid">
    ...
    <svg class="wp-art" viewBox="0 0 520 300" role="img" aria-label="Eine Kurve mit markiertem Wendepunkt. Notizen: Energiekostensteigerung, CO₂-Ausstoß, Rohstoff-Knappheit. Am Wendepunkt: hier.">
      ...
      <path class="wp-note" d="M70 128 C 60 160, 72 196, 104 226" fill="none" stroke="{PETROL}" stroke-width="3" stroke-linecap="round"/>
      <path class="wp-note" d="M88 220 L 106 229 L 104 209" fill="none" stroke="{PETROL}" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</section>
