...
<footer class="deep site-foot">
  <div class="wrap">
    <span class="fsig"><svg viewBox="0 0 64 64" width="22" height="22" aria-hidden="true"><path d="M6 52 C 30 52 34 12 58 12" fill="none" stroke="#fff" stroke-width="4.5" stroke-linecap="round"/><circle cx="32" cy="32" r="5.5" fill="#C8F04A"/></svg>Wendepunkt Ingenieure GbR · Büro für Energie- und Ressourceneffizienz · Thüringen / Leipzig</span>
