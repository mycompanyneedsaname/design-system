...
(UUID-Form in Kommentar-Benachrichtigungen: `https://claude.ai/code/artifact/ad826d4f-3948-4412-b55c-7b5bc7f6ae10`). Aktuell Version 68, privat. Die Freigabe macht der Nutzer über das Share-Menü.
...
2. **Team** (`#team`, ohne Eyebrow): Überschrift „Wir nehmen es persönlich.“, Micha und Tobias mit Rolle und Porträttext (Zitate auf Wunsch gelöscht), darunter zwei symmetrische Ströme (Ressourcen, Energie), die zusammenlaufen und über die Sektionsgrenze in die Grundplatte „Ihr Betrieb“ am Kopf des Baukastens münden. Gezeichnete Duotone-Platzhalter-Porträts (Petrol/Sand, Label „Platzhalter“), Zitate mit Lime-Textmarker.
