...
- **3 · Baukasten (`#baukasten`, Petrol):** zentriert gestapelt (`.bk-stack`): „Unser Versprechen:“ (klein) / „Der Modulare Effizienz-Baukasten.“ / „Weniger Verbrauch, mehr Spielraum.“, darunter mittig die Handschrift-Notiz (ohne Pfeil, nicht mehr seitlich schwebend) und der Konfigurator, die Auswahl-Buttons und ganz unten der Erstgespräch-Button.
