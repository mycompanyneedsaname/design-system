...
- **2 · Team (`#team`):** Überschrift „Wir nehmen es persönlich.“ („persönlich“ mit Lime-Textmarker; alle Textmarker `.hl` und die Zitate werden beim Hereinscrollen animiert gezogen), Porträts von Michael Schenk (Ressourceneffizienz) und Tobias Wintsche (Energieeffizienz), auf dem Desktop **gespiegelt** (Michael: Text links, Foto rechts; Tobias: Foto links, Text rechts, Wunsch 24.09., die Fotos stehen dann symmetrisch in der Mitte), das Fachgebiet steht seit Version 87 **neben dem Namen** in der h3 (`span.role`, „Michael Schenk · Ressourceneffizienz“, Wunsch 24.09.), der Satz „verantwortet bei uns …“ ist dafür aus dem Fließtext raus. Texte aus Notion „3.5.1 Fragen an Tobias und Michael“. Fotos fehlen noch: gezeichnete Duotone-Platzhalter mit Label „Platzhalter“. Keine Zitate mehr (auf Wunsch gelöscht, 24.09.). Keine Notizen unter den Fotos (auf Wunsch gelöscht). Darunter (`.team-link`, nur Desktop) laufen zwei symmetrische Linien ohne Beschriftung (die Fachgebiete stehen ja am Namen; Labels an den Linien „können entfallen“, 24.09.) in der Mitte zusammen („beides zusammen gedacht.“ mit Lime-Marker) und führen über die Sektionsgrenze in den Baukasten: Dort (`.bk-link`) wird die Linie Lime und endet mit einem Punkt über „Unser Versprechen:“ (die separate Platte „Ihr Betrieb“ ist wieder entfernt). **Die Wendepunkt-Kurve nicht als Verbindung zwischen Energie und Ressourcen verwenden**: Sie steht für vorher/nachher, nicht für zwei gleichwertige Felder. Nie Lime als Schriftfarbe auf hell.
- **3 · Baukasten (`#baukasten`, Petrol):** seit Version 80 **zweispaltig wie der Einstieg** (`.bk-stack`, Grid 1fr 1fr, „abgehoben“ war die Rückmeldung zur zentrierten Bühne): links „Unser Versprechen:“ (klein) / „Der Modulare Effizienz-Baukasten.“ (gleiche Größe wie die H1) / „Weniger Verbrauch, mehr Spielraum.“ / Ablauf-Satz / Erstgespräch-Button / Kontaktzeile; rechts die Zeichnung mit der Legende. Der Button sitzt unten bündig mit der Reihe Material/Wasser (`.bk-l` Flex-Spalte, `.bk-cta{margin-top:auto}`). Auf dem Handy: Headline, Ablauf-Satz, Zeichnung, dann der Button (`.bk-l{display:contents}` + `order`). Die Lime-Linie aus dem Team knickt nach links ab und endet mit dem Punkt über „Unser Versprechen:“. Der Button ist ein `mailto:` auf **kontakt@wendepunkt-ingenieure.de (Platzhalter)**. Die Zeile „oder direkt: E-Mail · Telefon“ darunter ist auf Wunsch gelöscht (Version 83). Danach ein schmaler Footer (`.site-foot`) mit Logo-Signet (`.fsig`, Kurve weiß, Punkt Lime), Firmierung und Links Impressum / Datenschutz (**Ziele `#impressum`, `#datenschutz` sind Platzhalter**). Auf dem Handy ersetzt `.tl-m` („Ressourcen + Energie / beides zusammen gedacht.“) die ausgeblendeten Team-Linien.
- **Baukasten-Konfigurator:** neun Handlungsfelder auf 3×3-Grundplatte, zwei Gruppen. Energie: Strom, Wärme, Kälte, Druckluft, Speicher. Ressourcen: Material, Wasser, Reststoffe, Betriebsstoffe. **Kein PV**, keine Gruppe „Eigenerzeugung“. Steine abgerundet, oben Medien-Symbol, vorne Prozessname (passt sich der Breite an). **Rechner** (seit Version 91, Wunsch Tobias: „durch Auswählen der Maßnahmen eine Beispielmaßnahme inkl. Einsparpotential in % sehen, das sich aufaddiert“): Auswahl-Buttons (`button.chip`, Häkchen) setzen Steine auf die Platte; rechts neben der Zeichnung (`.bk-calc`) steht pro gewähltem Feld eine Beispielmaßnahme mit Prozent (`EX` im JS: Strom −6, Wärme −8, Kälte −3, Druckluft −4, Speicher −3, Material −5, Wasser −2, Reststoffe −3, Betriebsstoffe −2) und darunter die Summe „Zusammen −xx %“ groß in Lime. Fußnote mit Stern (Version 93, „denk dir etwas Plausibles aus“): „Richtwerte aus unseren Projekten in rund 150 Betrieben, bezogen auf die jährlichen Energie- und Materialkosten.“ (zweiter Satz auf Wunsch gestrichen, Version 94) Werte sind Entwürfe, von den Gründern zu bestätigen. Start-Auswahl: Strom, Wärme, Druckluft, Material. Die Liste zeigt immer alle neun Zeilen (nicht gewählte gedimmt mit „–“), damit die Höhe des Abschnitts konstant bleibt (Wunsch 24.09.). Die Steine bauen sich beim Hereinscrollen nacheinander auf (`#plate.on`, Keyframe `rise2`). Das Grid im Baukasten ist .8fr/1.2fr, damit Zeichnung und Rechnung nebeneinander passen; unter 640 px untereinander. Dazu (seit Version 76, Wunsch „alle 6 Punkte umsetzen“) ein Satz zum Ablauf: „Für jede Maßnahme: messen, nachrechnen, umsetzen. Sie entscheiden, welche wir angehen.“ (Wunsch: „Maßnahme“ statt Stein/Platte.) Keine Erklär-Box, keine Zahlenzeile.
