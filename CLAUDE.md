...
- **3 · Baukasten (`#baukasten`, Petrol):** zentriert gestapelt (`.bk-stack`): „Unser Versprechen:“ (klein) / „Der Modulare Effizienz-Baukasten.“ / „Weniger Verbrauch, mehr Spielraum.“, darunter mittig der Konfigurator (Handschrift-Notiz links daneben), die Auswahl-Buttons und ganz unten der Erstgespräch-Button.
