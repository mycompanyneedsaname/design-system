...
- **Baukasten-Konfigurator:** neun Handlungsfelder auf 3×3-Grundplatte, zwei Gruppen. Energie: Strom, Wärme, Kälte, Druckluft, Speicher. Ressourcen: Material, Wasser, Reststoffe, Betriebsstoffe. **Kein PV**, keine Gruppe „Eigenerzeugung“. Steine abgerundet, oben Medien-Symbol, vorne Prozessname (passt sich der Breite an). **Nicht mehr interaktiv** (seit Version 89, „Warum kann man hier rumklicken“): alle neun Steine stehen fest auf der Platte, darunter die neun Felder als stille Legende (`span.chip`), keine Buttons. Dazu (seit Version 76, Wunsch „alle 6 Punkte umsetzen“) ein Satz zum Ablauf: „Für jede Maßnahme: messen, nachrechnen, umsetzen. Sie entscheiden, welche wir angehen.“ (Wunsch: „Maßnahme“ statt Stein/Platte.) Keine Erklär-Box, keine Zahlenzeile.
