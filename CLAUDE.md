...
- **2 · Team (`#team`):** Überschrift „Wir nehmen es persönlich.“ („persönlich“ mit Lime-Textmarker), Porträts von Michael Schenk (Ressourceneffizienz) und Tobias Wintsche (Energieeffizienz), das Fachgebiet steht im Fließtext („kümmert sich bei uns um …“), nicht als Label. Texte aus Notion „3.5.1 Fragen an Tobias und Michael“. Fotos fehlen noch: gezeichnete Duotone-Platzhalter mit Label „Platzhalter“. Zitate in Kalam mit Lime-Textmarker (Petrol-Schrift, nie Lime als Schriftfarbe auf hell).
