...
- **Reihenfolge der Startseite** (Wunsch Tobias, 24.09.): 1. Wendepunkt als Einstieg, 2. Team (Wer wir sind), 3. Referenzen ganz knapp, 4. Modularer Effizienz-Baukasten. Danach Trennband „Ab hier: Markensystem“ mit den Systemseiten.
- **1 · Wendepunkt (Einstieg, Sand, `#start`):** Petrol-Schild mit Lime-Punkt „Wir sind ein Büro für Energie- und Ressourceneffizienz.“ über der H1 / H1 „Der Wendepunkt ist der Moment, ab dem es anders läuft.“ / „Wir suchen ihn gemeinsam mit Ihnen.“ / Button „Kostenfreies Erstgespräch vereinbaren“ (hellgrün #C8F04A, Petrol-Rahmen, ohne Icon). Der Kontakt-Button steht nur hier. Kurve mit handschriftlichen Notizen: davor „Energiekostensteigerung, CO₂-Ausstoß, Rohstoff-Knappheit“, danach „sinkende Betriebskosten, Flexibilität, Resilienz“, am Punkt „hier.“.
- **2 · Team (`#team`):** Überschrift „Wir nehmen es persönlich.“, Porträts von Michael Schenk (Ressourceneffizienz) und Tobias Wintsche (Energietechnik). Texte aus Notion „3.5.1 Fragen an Tobias und Michael“. Fotos fehlen noch (Platzhalter „Foto folgt“).
- **3 · Referenzen (`#praxis`):** drei Zeilen, derzeit Beispielwerte und als solche gekennzeichnet. Keine Wunschkunden als Referenz nennen.
- **4 · Baukasten (`#baukasten`, Petrol):** „Unser Versprechen:“ (klein) / „Der Modulare Effizienz-Baukasten.“ / „Weniger Verbrauch, mehr Spielraum.“ plus Konfigurator.
