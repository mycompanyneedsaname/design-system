...
- **2 · Team (`#team`):** Überschrift „Wir nehmen es persönlich.“ („persönlich“ mit Lime-Textmarker; alle Textmarker `.hl` und die Zitate werden beim Hereinscrollen animiert gezogen), Porträts von Michael Schenk (Ressourceneffizienz) und Tobias Wintsche (Energieeffizienz), das Fachgebiet steht im Fließtext („verantwortet bei uns …“, bei beiden), nicht als Label. Texte aus Notion „3.5.1 Fragen an Tobias und Michael“. Fotos fehlen noch: gezeichnete Duotone-Platzhalter mit Label „Platzhalter“. Keine Zitate mehr (auf Wunsch gelöscht, 24.09.). Unter jedem Foto eine kurze Handschrift-Notiz mit Pfeil („findet es in der ersten Stunde.“ / „baut es einfach.“). Darunter (`.team-link`, nur Desktop) fließen zwei Linien, „Ressourcen“ von Michael und „Energie“ von Tobias, in einen Baukasten-Stein „Ihr Betrieb“ (Lime-Deckfläche), Notiz „beides zusammen gedacht.“, beim Hereinscrollen gezeichnet. **Die Wendepunkt-Kurve nicht als Verbindung zwischen Energie und Ressourcen verwenden**: Sie steht für vorher/nachher, nicht für zwei gleichwertige Felder. Nie Lime als Schriftfarbe auf hell.
