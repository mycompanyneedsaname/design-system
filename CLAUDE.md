...
- **Baukasten-Konfigurator:** neun Handlungsfelder auf 3×3-Grundplatte, zwei Gruppen. Energie: Strom, Wärme, Kälte, Druckluft, Speicher. Ressourcen: Material, Wasser, Reststoffe, Betriebsstoffe. **Kein PV**, keine Gruppe „Eigenerzeugung“. Steine abgerundet, oben Medien-Symbol, vorne Prozessname (passt sich der Breite an). **Rechner** (seit Version 91, Wunsch Tobias: „durch Auswählen der Maßnahmen eine Beispielmaßnahme inkl. Einsparpotential in % sehen, das sich aufaddiert“): Auswahl-Buttons (`button.chip`, Häkchen) setzen Steine auf die Platte; rechts neben der Zeichnung (`.bk-calc`) steht pro gewähltem Feld eine Beispielmaßnahme mit Prozent (`EX` im JS: Strom −6, Wärme −8, Kälte −3, Druckluft −4, Speicher −3, Material −5, Wasser −2, Reststoffe −3, Betriebsstoffe −2) und darunter die Summe „Zusammen −xx %“ groß in Lime, plus Fußnote „Typische Werte aus vergleichbaren Betrieben …“. Werte sind Entwürfe, von den Gründern zu bestätigen. Start-Auswahl: Strom, Wärme, Druckluft, Material. Die Steine bauen sich beim Hereinscrollen nacheinander auf (`#plate.on`, Keyframe `rise2`). Das Grid im Baukasten ist .8fr/1.2fr, damit Zeichnung und Rechnung nebeneinander passen; unter 640 px untereinander. Dazu (seit Version 76, Wunsch „alle 6 Punkte umsetzen“) ein Satz zum Ablauf: „Für jede Maßnahme: messen, nachrechnen, umsetzen. Sie entscheiden, welche wir angehen.“ (Wunsch: „Maßnahme“ statt Stein/Platte.) Keine Erklär-Box, keine Zahlenzeile.
